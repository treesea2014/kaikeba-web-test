...
public class WebdriverFactory {
	 ...
	 * @return
	 */
/*	public WebDriver newInstanceOf(String browser) {
	 ...
	 * @return
	 */
	public static WebDriver chromeBrowserInstance(String classpath) {
		/*	String browserPath = classpath
				+ MemcachedUtil.getValue(CHROME_DRIVER_PATH, true);
		...
		logger.info("启动Chrome浏览器   [{}]", "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome");
		return driver;
	}
	...
	private WebDriver firefoxBrowserInstance(String classpath) {
		...
		File pathToFirefoxBinary = new File(
				(String) MemcachedUtil.getValue(FIRFOX_DRIVER_PATH, true));
		...
		logger.info("启动Firefox浏览器   [{}]",
				MemcachedUtil.getValue(FIRFOX_DRIVER_PATH, true));
		return driver;
	}
	...
	*//**
	...
	private WebDriver ieBrowserInstance(String classpath) {
		String browserPath = classpath
				+ MemcachedUtil.getValue(IE_DRIVER_PATH, true);
